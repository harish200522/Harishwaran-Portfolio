...
function App() {
  ...
  return <main>
    ...
    <section id="projects" className="portfolio"><div className="section-shell portfolio-heading fade-up"><p className="eyebrow">02 — SELECTED WORK</p><h2>Projects with a purpose.</h2><p>Six selected builds spanning AI, commerce and useful everyday software.</p></div><div className="section-shell project-grid">{projects.map((project, index) => <QuantumProjectCard key={project.title} project={project} index={index} onOpenGallery={(p) => { setSelectedProject(p); setActiveImageIndex(0); }} />)}</div></section>
    ...
    <footer className="footer section-shell"><div className="footer-brand"><a className="brand" href="#top">HARISHWARAN V S</a><p>Developer focused on useful digital experiences.</p><div className="socials"><a className="Btn" href="https://github.com/harish200522" target="_blank" rel="noreferrer" aria-label="GitHub"><span className="BG" /><span className="svgContainer"><FaGithub /></span></a><a className="uiverse-linkedin-btn" href="https://www.linkedin.com/in/harishwaran-v-s-966964378/" target="_blank" rel="noreferrer" aria-label="LinkedIn"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 512 512" fill="currentColor"><path d="M444.17 32H70.28C49.85 32 32 46.7 32 66.89v374.72C32 461.91 49.85 480 70.28 480h373.78c20.54 0 35.94-18.21 35.94-38.39V66.89C480.12 46.7 464.6 32 444.17 32zm-273.3 373.43h-64.18V205.88h64.18zM141 175.54h-.46c-20.54 0-33.84-15.29-33.84-34.43 0-19.49 13.65-34.42 34.65-34.42s33.85 14.82 34.31 34.42c-.01 19.14-13.31 34.43-34.66 34.43zm264.43 229.89h-64.18V296.32c0-26.14-9.34-44-32.56-44-17.74 0-28.24 12-32.91 23.69-1.75 4.2-2.22 9.92-2.22 15.76v113.66h-64.18V205.88h64.18v27.77c9.34-13.3 23.93-32.44 57.88-32.44 42.13 0 74 27.77 74 87.64z" /></svg><span className="uiverse-tooltip">Linkedin</span></a><a className="InstagramBtn" href="https://www.instagram.com/harishwaran_22_/" target="_blank" rel="noreferrer" aria-label="Instagram"><span className="BG" /><span className="svgContainer"><FaInstagram /></span></a></div></div><div className="footer-list"><p className="eyebrow">MENU</p>{navItems.map(([label, id]) => <a key={id} href={`#${id}`}>{label}</a>)}</div><div className="footer-list"><p className="eyebrow">MORE</p><a href="/resume.pdf" download>Download résumé</a><a href="mailto:vsharishwaran@gmail.com">Email me</a><a href="https://github.com/harish200522" target="_blank" rel="noreferrer">GitHub</a></div><p className="copyright">© 2026 HARISHWARAN V S — BUILT WITH INTENT.</p></footer>
