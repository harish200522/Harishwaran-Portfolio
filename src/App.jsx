...
function App() {
  ...
  return <main>
    ...
    <footer className="footer section-shell"><div className="footer-brand"><a className="brand" href="#top">HARISHWARAN V S</a><p>Developer focused on useful digital experiences.</p><div className="socials"><a className="Btn" href="https://github.com/harish200522" target="_blank" rel="noreferrer" aria-label="GitHub"><span className="BG" /><span className="svgContainer"><FaGithub /></span></a><a className="LinkedinBtn" href="https://www.linkedin.com/in/harishwaran-v-s-966964378/" target="_blank" rel="noreferrer" aria-label="LinkedIn"><span className="BG" /><span className="svgContainer"><FaLinkedinIn /></span></a><a className="InstagramBtn" href="https://www.instagram.com/harishwaran_22_/" target="_blank" rel="noreferrer" aria-label="Instagram"><span className="BG" /><span className="svgContainer"><FaInstagram /></span></a></div></div><div className="footer-list"><p className="eyebrow">MENU</p>{navItems.map(([label, id]) => <a key={id} href={`#${id}`}>{label}</a>)}</div><div className="footer-list"><p className="eyebrow">MORE</p><a href="/resume.pdf" download>Download résumé</a><a href="mailto:vsharishwaran@gmail.com">Email me</a><a href="https://github.com/harish200522" target="_blank" rel="noreferrer">GitHub</a></div><p className="copyright">© 2026 HARISHWARAN V S — BUILT WITH INTENT.</p></footer>
